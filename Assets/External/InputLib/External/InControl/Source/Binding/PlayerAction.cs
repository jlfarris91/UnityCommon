namespace InControl
{
	...
	public class PlayerAction : OneAxisInputControl
	{
		...
		/// </summary>
		/// <param name="keys">A list of one or more keys making up a KeyCombo for the binding source.</param>
		public void AddBinding(params Key[] keys)
        {
            AddBinding(new KeyBindingSource(keys));
        }
        ...
        /// </summary>
        /// <param name="control">The Mouse control to add.</param>
        public void AddBinding(Mouse control)
        {
            AddBinding(new MouseBindingSource(control));
        }
        ...
        /// </summary>
        /// <param name="control">The InputControlType to add.</param>
        public void AddBinding(InputControlType control)
        {
            AddBinding(new DeviceBindingSource(control));
        }
